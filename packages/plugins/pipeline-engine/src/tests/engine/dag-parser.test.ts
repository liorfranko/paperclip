  ...
  describe("parsePipeline", () => {
    ...
    it("defaults positions to empty object when not provided", () => {
      const json = JSON.stringify({
        name: "test",
        trigger: { label: "x" },
        stages: [{ id: "a", type: "stage", agent_role: "r", actionId: "triage-new-issues" }],
        edges: [],
      });
  ...
  describe("validateDAG", () => {
    ...
    it("detects cycles in forward edges", () => {
      const cyclic: PipelineDefinition = {
        ...
        trigger: { label: "test" },
        stages: [
          { id: "a", type: "stage", agent_role: "x", actionId: "triage-new-issues" },
          { id: "b", type: "stage", agent_role: "x", actionId: "triage-new-issues" },
        ],
        edges: [
          { id: "e1", from: "a", to: "b" },
          { id: "e2", from: "b", to: "a" },
    ...
    it("detects dangling edge source references", () => {
      const badRef: PipelineDefinition = {
        ...
        description: "test",
        trigger: { label: "test" },
        stages: [{ id: "a", type: "stage", agent_role: "x", actionId: "triage-new-issues" }],
    ...
    it("detects duplicate stage IDs", () => {
      const dupes: PipelineDefinition = {
        ...
        stages: [
          { id: "a", type: "stage", agent_role: "x", actionId: "triage-new-issues" },
          { id: "a", type: "stage", agent_role: "y", actionId: "triage-new-issues" },
        ],
        edges: [],
        positions: {},
      };
